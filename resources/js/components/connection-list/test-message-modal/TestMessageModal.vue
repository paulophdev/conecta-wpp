...
import { DialogRoot, DialogContent, DialogTitle, DialogDescription, DialogClose } from 'radix-vue';
import { X, Phone, MessageSquare } from 'lucide-vue-next'; // Adicionar ícones Phone e MessageSquare
import { ref } from 'vue';

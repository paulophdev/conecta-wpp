...
<template>
    <div class="voltage-button">
        <button class="relative rounded-xl bg-indigo-500 p-px font-medium text-white px-6 py-3 transition-colors group-hover/btn:bg-transparent">Criar conexão</button>
